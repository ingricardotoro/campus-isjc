...
const highSchoolTestimonials: ITestimonial[] = [
    {
        id: 1,
        rating: 5,
        content: "El programa académico de secundaria ha sido fundamental para mi desarrollo. Los profesores no solo se preocupan por nuestro rendimiento académico, sino también por nuestra formación en valores. El ambiente bilingüe me ha permitido mejorar significativamente mi inglés, preparándome para la universidad.",
        name: "David Mendoza",
        avatar: avatar1,
    ...
    },
    {
        id: 3,
        rating: 5,
        content: "Como estudiante de último año, puedo decir que el colegio me ha preparado extraordinariamente bien para mi futuro. El programa de orientación universitaria y el enfoque bilingüe me han abierto puertas a universidades internacionales. Además, las actividades extracurriculares han fortalecido mis habilidades de liderazgo.",
        name: "Fernando Alvarado",
        avatar: avatar3,
        designation: "Estudiante de 12vo Grado"
    },
    {
        id: 4,
        rating: 5,
