            ...
            <header>
                <div className="bd-header-top">
                    <div className="bd-header-top-left">
                        <ul>
                            <li><Link href="tel:+8884467880"><span><i className="fa-solid fa-phone-volume"></i></span>(+504) 2236-5298</Link></li>
                            <li><Link href="tel:+8884467880"><span><i className="fa-solid fa-phone-volume"></i></span>(+504) 9439-2201</Link></li>
                    ...
                    <div className="bd-header-top-right text-md-end">
                        <Link href="https://maps.app.goo.gl/J5zkKhJxy6R8C5dS8"><span><i className="fa-sharp fa-regular fa-location-dot"></i></span>La Campaña, Tegucigalpa, HN</Link>
                    </div>
                </div>
