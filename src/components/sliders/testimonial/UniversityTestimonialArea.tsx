                    ...
                    <div className="row gy-30 justify-content-between align-items-end section-title-space">
                        <div className="col-xl-5 col-lg-6">
                            <div className="bd-section-wrapper">
                                ...
                                <h2 className="bd-section-title text-white">Opiniones <span className="down-mark-line"> Estudiantiles</span>{" "}
                                    </h2>
                            </div>
                        </div>
                        <div className="col-xl-5 col-lg-6">
                            <p className="bd-section-paragraph text-white">La educación es uno de los activos más esenciales y valiosos que una persona puede poseer.
                            </p>
                        </div>
                    </div>
