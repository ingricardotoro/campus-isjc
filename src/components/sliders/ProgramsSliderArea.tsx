            ...
            <section className="bd-category-area section-space">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-xl-6">
                            <div className="bd-section-wrapper section-title-space text-center">
                                <span className="bd-section-subtitle">Totalmente Bilingüe</span>
                                <h2 className="bd-section-title mb-20">Grados Disponibles</h2>
                            </div>
                        </div>
                    </div>
                    <div className="kindergartenProgramActive">
                        ...
                        >
                            {
                                programData.slice(6, 9).map((item) => (
                                        ...
                                        <div className="bd-course-wrapper style-four">
                                            ...
                                            <div className={`bd-course-info-item-wrapper ${item.BgClass}`}>
                                                <div className="bd-course-info-item">
                                                    <h5 className="bd-course-info-item-title">{item.age} <br /><span>De Edad</span></h5>
                                                </div>
                                                <div className="bd-course-info-item">
                                                    <h5 className="bd-course-info-item-title">{item.duration} <br /><span>Semanales</span></h5>
                                                </div>
                                                <div className="bd-course-info-item">
                                                    <h5 className="bd-course-info-item-title">{item.hoursTime} <br /><span>Horas</span></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </SwiperSlide>
