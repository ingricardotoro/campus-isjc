...
import ctaThumb from '../../../../public/assets/images/cta/cancha.jpg';
...
const UniversityCtaSectionCommon = () => {
    return (
        <>
            {/* -- cta area start -- */}
            <section className="bd-cta-area section-space theme-bg p-relative fix">
                            ...
                            <div className="bd-cta-wrapper style-five">
                                <div className="bd-cta-content">
                                    <div className="bd-section-title-wrapper section-title-space">
                                        <h2 className="bd-section-title white-text mb-30">Complementamos tu Educación, con Artes y Deportes.
                                        </h2>
                                        <div className="bd-course-details-list">
                                            <ul>
                                                <li>
                                                    ...
                                                    Descubre tu máximo potencial con la mejor formación artistica y deportiva.
                                                </li>
                                                <li>
                                                    <span className="list-icon white">
                                                        <i className="fa-solid fa-check"></i>
                                                    </span>
                                                   Alcanza tus metas artísticas o deportivas con la guía de expertos.
                                                </li>
                                                <li>
                                                    <span className="list-icon white">
                                                        <i className="fa-solid fa-check"></i>
                                                    </span>
                                                    Sé parte de nuestras academias de Artes y Deportes.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
