                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-7">
                            <div className="bd-section-title-wrapper section-title-space text-center">
                                <span className="bd-section-subtitle">Nuestros</span>
                                <h2 className="bd-section-title">Próximos <span className="down-mark-line">Eventos</span></h2>
                            </div>
                        </div>
                    </div>
                    <div className="row gx-0 gy-30">
                        ...
                        <div className="col-xl-5">
                            <div className="bd-event-thumb style-two">
                                <Image src={eventos} alt="image" priority/>
                            </div>
                        </div>
                    </div>
