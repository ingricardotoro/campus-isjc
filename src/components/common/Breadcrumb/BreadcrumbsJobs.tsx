...
const BreadcrumbsJobs = ({ breadcrumbTitle, flexClass, textPosition }: breadCrumbType) => {
    return (
        <>
            {/* -- breadcrumb end -- */}
                            ...
                            <div className="col-xl-12">
                                <div className="bd-breadcrumb style-two d-flex-center">
                                    <div className="bd-breadcrumb-content">
                                        <h1 className={`bd-breadcrumb-title ${textPosition ? textPosition : "text-center"}`}>Proceso de Aplicación Laboral</h1>
...
export default BreadcrumbsJobs;