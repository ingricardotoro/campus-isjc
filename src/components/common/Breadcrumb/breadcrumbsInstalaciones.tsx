...
import breadcrumbBg from '../../../../public/assets/images/breadcrumb/basica1.png'

interface breadCrumbType{
    breadcrumbTwoTitle:string
}
const BreadcrumbsInstalaciones = ({breadcrumbTwoTitle}:breadCrumbType) => {
    return (
        <>
                            ...
                            <div className="col-xl-12">
                                <div className="bd-breadcrumb d-flex-start">
                                    <div className="bd-breadcrumb-content">
                                        <h1 className="bd-breadcrumb-title">Instalaciones</h1>
                                         {/*<div className="bd-breadcrumb-list has-white justify-content-start">
                                            <span><Link href="/">ISJC</Link></span>
...
export default BreadcrumbsInstalaciones;