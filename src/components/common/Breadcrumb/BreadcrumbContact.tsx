...
const BreadcrumbsContact = ({ breadcrumbTitle, flexClass, textPosition }: breadCrumbType) => {
    return (
        <>
            {/* -- breadcrumb end -- */}
                            ...
                            <div className="col-xl-12">
                                <div className="bd-breadcrumb style-two d-flex-center">
                                    <div className="bd-breadcrumb-content">
                                        <h1 className={`bd-breadcrumb-title ${textPosition ? textPosition : "text-center"}`}>Área de Contacto</h1>
