...
import breadcrumbBg from '../../../../public/assets/images/breadcrumb/sanjosedelcarmen4_lite.png'

interface breadCrumbType{
    breadcrumbTwoTitle:string
}
const BreadcrumbsMV = ({breadcrumbTwoTitle}:breadCrumbType) => {
    return (
        <>
                            ...
                            <div className="col-xl-12">
                                <div className="bd-breadcrumb d-flex-start">
                                    <div className="bd-breadcrumb-content">
                                        <h1 className="bd-breadcrumb-title">Misión y Visión</h1>
