...
import breadcrumbBg from '../../../../public/assets/images/breadcrumb/sanjosedelcarmen2_lite.png'

interface breadCrumbType{
    breadcrumbTwoTitle?: string
}
const BreadcrumbsTwo = ({}:breadCrumbType) => {
    return (
        <>
                            ...
                            <div className="col-xl-12">
                                <div className="bd-breadcrumb d-flex-start">
                                    <div className="bd-breadcrumb-content">
                                        <h1 className="bd-breadcrumb-title">HISTORIA</h1>
