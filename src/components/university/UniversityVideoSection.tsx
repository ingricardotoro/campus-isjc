...
import videoBg from "../../../public/assets/images/bg/sanjosedelcarmen.png";
                                ...
                                <div className="bd-video-wrapper">
                                    <div className="bd-video-content">
                                        <div className="bd-section-title-wrapper">
                                            <h2 className="bd-section-title">Visita nuestro <span className="text-secondary">Polideportivo</span>{" "}
                                               y conoce nuestras academias de <span
                                                    className="text-secondary">Arte y Deporte</span>
                                            </h2>
                                        </div>
                                        <p>Forma parte de nuestras academias , donde desarrollamos tus habilidades con profesionales.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-6 col-lg-4">
                                <div className="bd-video-play-btn">
                                    <button  type='button' onClick={() => playVideo("-S0vuRBOKUo", "youtube")} className="bd-video-btn popup-video has-bg">
