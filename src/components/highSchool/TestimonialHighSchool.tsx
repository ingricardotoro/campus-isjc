                        ...
                        <div className="col-xxl-7 col-xl-6 col-lg-6">
                            <div className="bd-testimonial-wrap section-space">
                                ...
                                <div className="bd-section-title-wrapper section-title-space">
                                    ...
                                    <h2 className="bd-section-title white-text mb-20">La Voz de Nuestros <span
                                ...
                                <div className="swiper testimonialActiveFour">
                                    ...
                                    >
                                        {
                                            highSchoolTestimonials.map((item) => (
                                                <SwiperSlide key={`testimonial-hs-${item.id}`}>
...
export default TestimonialHighSchool;