                    ...
                    <div  className="row justify-content-center">
                        <div  className="col-xl-6">
                            <div  className="bd-section-title-wrapper section-title-space text-center">
                                <h2  className="bd-section-title">Nuestras Instalaciones</h2>
                            </div>
                        </div>
                    </div>
                    <div  className="row gy-30 justify-content-center">
                        <div  className="col-lg-12">
                            <div  className="bd-campus-story-content text-center">
                               <p className="bd-campus-story-highlight">
                                    Te invitamos a conocer y disfrutar de nuestras instalaciones, espacios diseñados para fomentar la creatividad y el talento.
                                </p> 
                                    {/*
