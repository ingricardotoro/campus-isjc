...
const FacultyDirectorySvg = () => {
    return (
        <>
            <svg width="49" height="49" viewBox="0 0 49 49" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M24.5 44.5L20.5 32.5H4.5L8.5 44.5H24.5ZM24.5 44.5H32.5" stroke="#002147"
                ...
                <path
                    ...
                    stroke="#002147" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                <path
...
export default FacultyDirectorySvg;